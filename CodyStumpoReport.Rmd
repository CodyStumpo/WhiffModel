...
qplot(example$inside, sort(rep(Z, 50)), colour=example$swingingstrike) + scale_colour_gradient(limits=c(0, 1), low="green", high="red") +
  geom_rect(xmin = -8.5/12, xmax = 8.5/12,   ymin = 1.5, ymax = 3.5, 
           fill=NA, linetype=1, color="black", size=1) +
  labs(title = "Modeled 92mph FB @ 2150 rpm, RHP to RHB", x="Inside (catcher's POV)", y = "Pitch Height", colour="Whiff")
